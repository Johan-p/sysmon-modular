# sysmon-modular | Personal fork
See https://github.com/olafhartong/sysmon-modula for original version
...
The sysmonconfig.xml within the repo is automatically generated after a successful merge by the PowerShell script.
...
#### PowerShell
    ...
    $> git clone https://github.com/Johan-p/sysmon-modular-test1.git
    $> cd sysmon modular
    $> . .\Merge-SysmonXml.ps1
...
## Credits
OlafHartong https://github.com/olafhartong/sysmon-modula
